//
//  Acquire_LowPass_Continuous_2.c
//
//  Requires file motion_data_sensor_tile_2.sh
//
//
//  Includes Autofilter.c 
...
#define OUTPUT_FILE "motion_data_output_2.csv"

#define SAMPLE_PERIOD 0.050

const char SIGNAL_AX[] = "tempfile_ax_2.txt";
const char SIGNAL_AY[] = "tempfile_ay_2.txt";
const char SIGNAL_AZ[] = "tempfile_az_2.txt";

const char SIGNAL_GX[] = "tempfile_gx_2.txt";
const char SIGNAL_GY[] = "tempfile_gy_2.txt";
const char SIGNAL_GZ[] = "tempfile_gz_2.txt";

const char SIGNAL_MX[] = "tempfile_mx_2.txt";
const char SIGNAL_MY[] = "tempfile_my_2.txt";
const char SIGNAL_MZ[] = "tempfile_mz_2.txt";
...
void sig_handler_data_acq_1(int handler_val)
{
			...
			printf("Current POSIX time at start of data acquisition 2 seconds %i\n",handler_exec_time.tv_sec);
			printf("Current POSIX time at start of data acquisition 2 nanoseconds %i\n",handler_exec_time.tv_nsec);
			system("bash motion_data_sensortile_2.sh -t 10 -f sensor_data_stream_2.dat");
}
 ...
 */
	...
	sample_count_file = "sample_count_2.dat";
	...
	printf(" Number of samples acquired task 2 =  %i \n", size);
	fprintf(fp,"%i\n",size);
	fclose(fp);
